            ...
            <div className="w-full max-w-md p-8 space-y-6 bg-white rounded-lg shadow-md">
                <div className="text-center">
                    <h1 className="text-3xl font-bold text-gray-900">
                        <span className="text-sky-600">Gtec Drone</span> Admin
                    </h1>
                    <p className="mt-2 text-sm text-gray-600">Acesso ao painel administrativo</p>
                </div>
                <form className="space-y-6" onSubmit={handleSubmit}>
                    <div>
                        <label htmlFor="username" className="text-sm font-bold text-gray-600 block">Usuário</label>
                        <input
                            id="username"
                            type="text"
                            value={username}
